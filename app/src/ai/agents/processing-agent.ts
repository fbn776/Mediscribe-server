...
Your job is to return a JSON object with three nullable fields: "corrected", "highlight", and "summarized".
...
Rules:
- "corrected": Fix typos, grammar mistakes, and misheard/misrecognized words (especially medical terms) in the combined text. Preserve meaning. Set to null if no corrections are needed or if the text is too short (< 20 words).
